...
from .views import get_tweet_data, get_avg_students_by_hour, get_avg_students_day_total, get_latest_tweets, get_avg_students_days, get_avg_students_by_hour, average_students_by_hour
...
urlpatterns = [
    ...
    path('avg/hours', average_students_by_hour, name='average_students_by_hour'),
]
